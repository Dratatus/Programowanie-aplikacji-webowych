  ...
  <div class="min-h-screen bg-gray-100 dark:bg-gray-900 py-10">
    <div class="container mx-auto max-w-7xl">
      ...
      <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md">
        <h2 class="text-2xl font-semibold mb-5 text-gray-900 dark:text-gray-100">Projects List</h2>
        <ul class="space-y-3">
          ...
          <li v-if="projects.length === 0" class="text-center text-gray-500 dark:text-gray-400">No projects found.</li>
        </ul>
      </div>
    </div>
  </div>
